...
while(acc<2):
    ...
    window.button_upload = Button(window,text="Upload pictures",width=10)
    ...
    def callback2(event):
        webbrowser.open_new("https://github.com/MeditatorE/Face-time-travel-machine")
    ...
    def clear(*args):
        ...
        path = "./results/aging_cyclegan/test_latest/images"
        path_dir = os.listdir(path)
        i = 0
        for filename in path_dir:  # 遍历pathDir下的所有文件filename
            i = i + 1
        ...
        full_path = "./results/aging_cyclegan/test_latest/index.html"
        os.remove(full_path)
